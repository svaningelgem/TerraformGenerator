...
public class TerraformChunkGenerator extends ChunkGenerator {
    ...
    TerraformChunkGenerator(@NotNull TConfig config, @NotNull HeightMap heightMap, @NotNull TLogger logger) {
        this.config = config;
