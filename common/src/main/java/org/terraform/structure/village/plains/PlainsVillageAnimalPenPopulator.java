...
//                	highest = roomY;
                ...
                if(Math.abs(highest-roomY) > config.STRUCTURES_PLAINSVILLAGE_HEIGHT_TOLERANCE)
                	continue;
...
//    		            	core.getAtY(roomY+1);
    	                ...
    	                if(Math.abs(core.getY()-roomY) > config.STRUCTURES_PLAINSVILLAGE_HEIGHT_TOLERANCE)
    	                	continue;
