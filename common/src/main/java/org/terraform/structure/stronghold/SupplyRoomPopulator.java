    ...
    public void populate(@NotNull PopulatorDataAbstract data, @NotNull CubeRoom room) {
        ...
        if (TConfig.areDecorationsEnabled()) {
            ...
            for (int i = 0; i < GenUtils.randInt(rand, 5, 20); i++) {
                ...
                Material type = GenUtils.randChoice(
                        rand,
            ...
            for (int i = 0; i < GenUtils.randInt(rand, 5, 20); i++) {
                ...
                new ChestBuilder(Material.CHEST).setFacing(BlockUtils.getDirectBlockFace(rand)).setLootTable(TerraLootTable.STRONGHOLD_CROSSING).apply(data, x, ny, z);
            }
        }
