...
public enum BiomeBank {
    //MOUNTAINOUS
    SNOWY_MOUNTAINS(new SnowyMountainsHandler(), BiomeType.MOUNTAINOUS, BiomeClimate.SNOWY, config.BIOME_SNOWY_MOUNTAINS_WEIGHT, new FrozenCavePopulator()),
    BIRCH_MOUNTAINS(new BirchMountainsHandler(), BiomeType.MOUNTAINOUS, BiomeClimate.COLD, config.BIOME_BIRCH_MOUNTAINS_WEIGHT),
    ROCKY_MOUNTAINS(new RockyMountainsHandler(), BiomeType.MOUNTAINOUS, BiomeClimate.TRANSITION, config.BIOME_ROCKY_MOUNTAINS_WEIGHT),
    FORESTED_MOUNTAINS(new ForestedMountainsHandler(), BiomeType.MOUNTAINOUS, BiomeClimate.HUMID_VEGETATION, config.BIOME_FORESTED_MOUNTAINS_WEIGHT, new ForestedMountainsCavePopulator()),
    SHATTERED_SAVANNA(new ShatteredSavannaHandler(), BiomeType.MOUNTAINOUS, BiomeClimate.DRY_VEGETATION, config.BIOME_SHATTERED_SAVANNA_WEIGHT),
    PAINTED_HILLS(new PaintedHillsHandler(), BiomeType.MOUNTAINOUS, BiomeClimate.DRY_VEGETATION, config.BIOME_PAINTED_HILLS_WEIGHT),
    BADLANDS_CANYON(new BadlandsCanyonHandler(), BiomeType.MOUNTAINOUS, BiomeClimate.HOT_BARREN, config.BIOME_BADLANDS_MOUNTAINS_WEIGHT),
    //For now, disabled by default.
    DESERT_MOUNTAINS(new DesertHillsHandler(), BiomeType.MOUNTAINOUS, BiomeClimate.HOT_BARREN, config.BIOME_DESERT_MOUNTAINS_WEIGHT),

    //HIGH MOUNTAINOUS
    JAGGED_PEAKS(new JaggedPeaksHandler(), BiomeType.HIGH_MOUNTAINOUS, BiomeClimate.SNOWY, config.BIOME_JAGGED_PEAKS_WEIGHT, new FrozenCavePopulator()),
    COLD_JAGGED_PEAKS(new JaggedPeaksHandler(), BiomeType.HIGH_MOUNTAINOUS, BiomeClimate.COLD, config.BIOME_JAGGED_PEAKS_WEIGHT, new FrozenCavePopulator()),
    TRANSITION_JAGGED_PEAKS(new JaggedPeaksHandler(), BiomeType.HIGH_MOUNTAINOUS, BiomeClimate.TRANSITION, config.BIOME_JAGGED_PEAKS_WEIGHT, new FrozenCavePopulator()),
    FORESTED_PEAKS(new ForestedMountainsHandler(), BiomeType.HIGH_MOUNTAINOUS, BiomeClimate.HUMID_VEGETATION, config.BIOME_FORESTED_MOUNTAINS_WEIGHT, new ForestedMountainsCavePopulator()),
    SHATTERED_SAVANNA_PEAK(new ShatteredSavannaHandler(), BiomeType.HIGH_MOUNTAINOUS, BiomeClimate.DRY_VEGETATION, config.BIOME_SHATTERED_SAVANNA_WEIGHT),
    BADLANDS_CANYON_PEAK(new BadlandsCanyonHandler(), BiomeType.HIGH_MOUNTAINOUS, BiomeClimate.HOT_BARREN, config.BIOME_BADLANDS_MOUNTAINS_WEIGHT),
    
    //OCEANIC
    OCEAN(new OceansHandler(BiomeType.OCEANIC), BiomeType.OCEANIC, BiomeClimate.TRANSITION, config.BIOME_OCEAN_WEIGHT),
    BLACK_OCEAN(new BlackOceansHandler(BiomeType.OCEANIC), BiomeType.OCEANIC, BiomeClimate.TRANSITION, config.BIOME_BLACK_OCEAN_WEIGHT),
    COLD_OCEAN(new ColdOceansHandler(BiomeType.OCEANIC), BiomeType.OCEANIC, BiomeClimate.COLD, config.BIOME_COLD_OCEAN_WEIGHT),
    FROZEN_OCEAN(new FrozenOceansHandler(BiomeType.OCEANIC), BiomeType.OCEANIC, BiomeClimate.SNOWY, config.BIOME_FROZEN_OCEAN_WEIGHT, new FrozenCavePopulator()),
    WARM_OCEAN(new WarmOceansHandler(BiomeType.OCEANIC), BiomeType.OCEANIC, BiomeClimate.HOT_BARREN, config.BIOME_WARM_OCEAN_WEIGHT),
    HUMID_OCEAN(new WarmOceansHandler(BiomeType.OCEANIC), BiomeType.OCEANIC, BiomeClimate.HUMID_VEGETATION, config.BIOME_HUMID_OCEAN_WEIGHT),
    DRY_OCEAN(new WarmOceansHandler(BiomeType.OCEANIC), BiomeType.OCEANIC, BiomeClimate.DRY_VEGETATION, config.BIOME_DRY_OCEAN_WEIGHT),
    CORAL_REEF_OCEAN(new CoralReefOceanHandler(BiomeType.OCEANIC), BiomeType.OCEANIC, BiomeClimate.HUMID_VEGETATION, config.BIOME_CORALREEF_OCEAN_WEIGHT),
    ...
    //DEEP OCEANIC
    DEEP_OCEAN(new OceansHandler(BiomeType.DEEP_OCEANIC), BiomeType.DEEP_OCEANIC, BiomeClimate.TRANSITION, config.BIOME_DEEP_OCEAN_WEIGHT),
    DEEP_COLD_OCEAN(new ColdOceansHandler(BiomeType.DEEP_OCEANIC), BiomeType.DEEP_OCEANIC, BiomeClimate.COLD, config.BIOME_DEEP_COLD_OCEAN_WEIGHT),
    DEEP_BLACK_OCEAN(new BlackOceansHandler(BiomeType.DEEP_OCEANIC), BiomeType.DEEP_OCEANIC, BiomeClimate.TRANSITION, config.BIOME_DEEP_BLACK_OCEAN_WEIGHT),
    DEEP_FROZEN_OCEAN(new FrozenOceansHandler(BiomeType.DEEP_OCEANIC), BiomeType.DEEP_OCEANIC, BiomeClimate.SNOWY, config.BIOME_DEEP_FROZEN_OCEAN_WEIGHT, new FrozenCavePopulator()),
    DEEP_WARM_OCEAN(new WarmOceansHandler(BiomeType.DEEP_OCEANIC), BiomeType.DEEP_OCEANIC, BiomeClimate.HOT_BARREN, config.BIOME_DEEP_WARM_OCEAN_WEIGHT),
    DEEP_HUMID_OCEAN(new WarmOceansHandler(BiomeType.DEEP_OCEANIC), BiomeType.DEEP_OCEANIC, BiomeClimate.HUMID_VEGETATION, config.BIOME_DEEP_HUMID_OCEAN_WEIGHT),
    DEEP_DRY_OCEAN(new WarmOceansHandler(BiomeType.DEEP_OCEANIC), BiomeType.DEEP_OCEANIC, BiomeClimate.DRY_VEGETATION, config.BIOME_DEEP_DRY_OCEAN_WEIGHT),
    DEEP_LUKEWARM_OCEAN(new LukewarmOceansHandler(BiomeType.DEEP_OCEANIC), BiomeType.DEEP_OCEANIC, BiomeClimate.HUMID_VEGETATION, config.BIOME_DEEP_LUKEWARM_OCEAN_WEIGHT),
    MUSHROOM_ISLANDS(new MushroomIslandHandler(), BiomeType.DEEP_OCEANIC, BiomeClimate.TRANSITION, config.BIOME_MUSHROOM_ISLAND_WEIGHT),

    //FLAT
    PLAINS(new PlainsHandler(), BiomeType.FLAT, BiomeClimate.TRANSITION, config.BIOME_PLAINS_WEIGHT),
    ELEVATED_PLAINS(new ElevatedPlainsHandler(), BiomeType.FLAT, BiomeClimate.TRANSITION, config.BIOME_ELEVATED_PLAINS_WEIGHT),
    GORGE(new GorgeHandler(), BiomeType.FLAT, BiomeClimate.TRANSITION, config.BIOME_GORGE_WEIGHT),
    PETRIFIED_CLIFFS(new PetrifiedCliffsHandler(), BiomeType.FLAT, BiomeClimate.TRANSITION, config.BIOME_PETRIFIEDCLIFFS_WEIGHT),
    ARCHED_CLIFFS(new ArchedCliffsHandler(), BiomeType.FLAT, BiomeClimate.TRANSITION, config.BIOME_ARCHED_CLIFFS_WEIGHT),
    SAVANNA(new SavannaHandler(), BiomeType.FLAT, BiomeClimate.DRY_VEGETATION, config.BIOME_SAVANNA_WEIGHT),
    MUDDY_BOG(new MuddyBogHandler(), BiomeType.FLAT, BiomeClimate.DRY_VEGETATION, config.BIOME_MUDDYBOG_WEIGHT),
    FOREST(new ForestHandler(), BiomeType.FLAT, BiomeClimate.HUMID_VEGETATION, config.BIOME_FOREST_WEIGHT),
    JUNGLE(new JungleHandler(), BiomeType.FLAT, BiomeClimate.HUMID_VEGETATION, config.BIOME_JUNGLE_WEIGHT),
    BAMBOO_FOREST(new BambooForestHandler(), BiomeType.FLAT, BiomeClimate.HUMID_VEGETATION, config.BIOME_BAMBOO_FOREST_WEIGHT),
    DESERT(new DesertHandler(), BiomeType.FLAT, BiomeClimate.HOT_BARREN, config.BIOME_DESERT_WEIGHT),
    BADLANDS(new BadlandsHandler(), BiomeType.FLAT, BiomeClimate.HOT_BARREN, config.BIOME_BADLANDS_WEIGHT),
    ERODED_PLAINS(new ErodedPlainsHandler(), BiomeType.FLAT, BiomeClimate.COLD, config.BIOME_ERODED_PLAINS_WEIGHT),
    SCARLET_FOREST(new ScarletForestHandler(), BiomeType.FLAT, BiomeClimate.COLD, config.BIOME_SCARLETFOREST_WEIGHT),
    CHERRY_GROVE(new CherryGroveHandler(), BiomeType.FLAT, BiomeClimate.COLD, config.BIOME_CHERRYGROVE_WEIGHT),
    TAIGA(new TaigaHandler(), BiomeType.FLAT, BiomeClimate.COLD, config.BIOME_TAIGA_WEIGHT),
    SNOWY_TAIGA(new SnowyTaigaHandler(), BiomeType.FLAT, BiomeClimate.SNOWY, config.BIOME_SNOWY_TAIGA_WEIGHT, new FrozenCavePopulator()),
    SNOWY_WASTELAND(new SnowyWastelandHandler(), BiomeType.FLAT, BiomeClimate.SNOWY, config.BIOME_SNOWY_WASTELAND_WEIGHT, new FrozenCavePopulator()),
    ICE_SPIKES(new IceSpikesHandler(), BiomeType.FLAT, BiomeClimate.SNOWY, config.BIOME_ICE_SPIKES_WEIGHT, new FrozenCavePopulator()),
    DARK_FOREST(new DarkForestHandler(), BiomeType.FLAT, BiomeClimate.HUMID_VEGETATION, config.BIOME_DARK_FOREST_WEIGHT),
    SWAMP(new SwampHandler(), BiomeType.FLAT, BiomeClimate.HUMID_VEGETATION, config.BIOME_SWAMP_WEIGHT),
    MANGROVE(new MangroveHandler(), BiomeType.FLAT, BiomeClimate.HUMID_VEGETATION, config.BIOME_MANGROVE_WEIGHT),
...
//		sect.doCalculations();
	...
	public static void initSinglesConfig() {
    	try
    	{ singleLand = BiomeBank.valueOf(config.BIOME_SINGLE_TERRESTRIAL_TYPE.toUpperCase(Locale.ENGLISH)); }
    	catch(IllegalArgumentException e)
    		{singleLand = null;}
    	try
    	{ singleOcean = BiomeBank.valueOf(config.BIOME_SINGLE_OCEAN_TYPE.toUpperCase(Locale.ENGLISH)); }
    	catch(IllegalArgumentException e)
    		{singleOcean = null;}
    	try
    	{ singleDeepOcean = BiomeBank.valueOf(config.BIOME_SINGLE_DEEPOCEAN_TYPE.toUpperCase(Locale.ENGLISH)); }
    	catch(IllegalArgumentException e)
    		{singleDeepOcean = null;}
    	try
    	{ singleMountain = BiomeBank.valueOf(config.BIOME_SINGLE_MOUNTAIN_TYPE.toUpperCase(Locale.ENGLISH)); }
    	catch(IllegalArgumentException e)
    		{singleMountain = null;}
    	try
    	{ singleHighMountain = BiomeBank.valueOf(config.BIOME_SINGLE_HIGHMOUNTAIN_TYPE.toUpperCase(Locale.ENGLISH)); }
    	catch(IllegalArgumentException e)
    ...
    public static @Nullable BiomeBank selectBiome(@NotNull BiomeSection section, double temperature, double moisture) {
    	...
    	if(oceanicNoise < 0 || (float)config.BIOME_OCEANIC_THRESHOLD < 0)
    	{
    		 oceanicNoise = Math.abs(oceanicNoise);
	    	if(oceanicNoise >= (float)config.BIOME_DEEP_OCEANIC_THRESHOLD){
	    		targetType = BiomeType.DEEP_OCEANIC;
	    	}else if(oceanicNoise >= (float)config.BIOME_OCEANIC_THRESHOLD){
    	...
    	else
    	{
    		...
    		if(mountainousNoise > 0) {
    			if(mountainousNoise >= (float)config.BIOME_HIGH_MOUNTAINOUS_THRESHOLD){
    	    		targetType = BiomeType.HIGH_MOUNTAINOUS;
    	    	}else if(mountainousNoise >= (float)config.BIOME_MOUNTAINOUS_THRESHOLD){
