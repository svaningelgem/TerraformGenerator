...
public class TConfig extends YamlFileInterface implements InjectableObject {
    ...
    public double BIOME_TEMPERATURE_FREQUENCY = 0.03d;
    @YamlKey("biome.moisture-frequency")
    public double BIOME_MOISTURE_FREQUENCY = 0.03d;
    @YamlKey("biome.mountainous-threshold")
    public double BIOME_MOUNTAINOUS_THRESHOLD = 18.5d;
    @YamlKey("biome.highmountains-threshold")
    public double BIOME_HIGH_MOUNTAINOUS_THRESHOLD = 27.5d;
    @YamlKey("biome.mountainous-frequency")
    public double BIOME_MOUNTAINOUS_FREQUENCY = 0.30d;
    @YamlKey("biome.oceanic-frequency")
    public double BIOME_OCEANIC_FREQUENCY = 0.11d;
    @YamlKey("biome.oceanic-threshold")
    public double BIOME_OCEANIC_THRESHOLD = 22d;
    ...
    public double BIOME_CAVE_CRYSTALLINECLUSTER_MAXPERTUB = 0.37d;
    ...
    public double BIOME_DEEP_OCEANIC_THRESHOLD = 27d;
    ...
    public double BIOME_CLAY_DEPOSIT_SIZE = 3d;
    ...
    // @YamlKey("biome.single.river")
// public String BIOME_SINGLE_RIVER_TYPE = "disabled";
// @YamlKey("biome.single.beach")
// public String BIOME_SINGLE_BEACH_TYPE = "disabled";
    ...
    public double BIOME_BADLANDS_PLATEAU_FREQUENCY = 0.01d;
    ...
    public double BIOME_OASIS_FREQUENCY = 0.012d;
    ...
    //-=[MISC]=-
// @YamlKey("misc.smooth-design")
// public boolean MISC_SMOOTH_DESIGN = false;
    ...
    // @YamlKey("dev-stuff.experimental-structure-placement")
// public boolean DEVSTUFF_EXPERIMENTAL_STRUCTURE_PLACEMENT = false;
...
// @YamlKey("caves.allow-flooded-ravines")
// public boolean CAVES_ALLOW_FLOODED_RAVINES = true;
...
//
//    public TConfig(ConfigLoader loader) {
//        for(Option option : Option.values()) {
//            loader.reg(option.path, option.value);
//        }
//        loader.load();
//        for(Option option : Option.values()) {
//                values.put(option, loader.get(option.path));
//        }
//    }
//
//    public String parse(Option option, String... placeholders) {
//        String parsed = this.getString(option);
//
//        String placeholder = "";
//
